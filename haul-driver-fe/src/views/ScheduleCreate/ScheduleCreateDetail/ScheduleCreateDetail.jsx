...
import { orderApprove, orderDetail } from "../../../repository/createRepository.jsx";
...
const ScheduleCreateDetail = () => {
  ...
  return (
    <MobileLayout>
        ...
        <Margin height="24px" />
        <DetailInfo
          srcCoordinate={{lat: orderData.src.latitude, lng: orderData.src.longitude}}
          srcAddress={orderData.src.address}
          srcName={orderData.src.name}
          dstCoordinate={{lat: orderData.dst.latitude, lng: orderData.dst.longitude}}
          dstAddress={orderData.dst.address}
          dstName={orderData.dst.name}
          fee={orderData.cost}
