...
VALUES
    ('TRUCK500', '포터2', 'truck500_photo.jpg', 200, 300, 400, 1000, 'DEFAULT', false,  NOW(), NOW()),
    ('TRUCK500', '포터2', 'truck500_photo.jpg', 200, 300, 400, 1000, 'DEFAULT', true,  NOW(), NOW()),
    ('TRUCK500', '포터2', 'truck500_photo.jpg', 200, 300, 400, 1000, 'IS_REFRIGERABLE', true,  NOW(), NOW()),
    ('TRUCK500', '포터2', 'truck500_photo.jpg', 200, 300, 400, 1000, 'IS_FREEZABLE', true,  NOW(), NOW()),
