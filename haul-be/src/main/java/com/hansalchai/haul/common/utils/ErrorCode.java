...
public enum ErrorCode {
	...
	UNAUTHORIZED_ACCESS(FORBIDDEN, "1004", "리소스 접근 권한이 없습니다."),
	UNSUPPORTED_QUERY_VALUE(BAD_REQUEST, "1005", "지원하지 않는 쿼리스트링 값입니다."),
	...
	//예약조회
	INVALID_RESERVATION_STATE_CHANGE (FORBIDDEN, "4001", "예약 전 상태에서만 상태를 변경할 수 있습니다."),

	// 오더
	ALREADY_ASSIGNED_DRIVER(CONFLICT, "5001", "이미 드라이버가 배정된 예약입니다."),
	ALREADY_DELIVERED(CONFLICT, "5002", "이미 운송 완료된 오더입니다.");
