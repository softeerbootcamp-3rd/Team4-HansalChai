...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
	...
	@Query("select r "
		...
		+ "and r.car.carId = :carId "
		 + "and cast(r.date || ' ' || r.time AS timestamp) > current_timestamp "
		+ "and s.sido in :sidoArray")
	Page<Reservation> findAllOrdersV2(@Param("carId") Long carId,@Param("sidoArray")ArrayList<String> sidoArray, Pageable pageable );  // 오더 접수순으로 정렬
	...
	@Query("select r "
		...
		+ "and s.sido in :sidoArray "
		+ "order by t.fee desc")
	Page<Reservation> findAllOrderByFeeV2(@Param("carId") Long carId,@Param("sidoArray")ArrayList<String> sidoArray, Pageable pageable);
	...
	@Query("select r "
		...
		+ "and s.sido in :sidoArray "
		+ "order by r.date, r.time")
	Page<Reservation> findAllOrderByDateTimeV2(@Param("carId") Long carId,@Param("sidoArray")ArrayList<String> sidoArray, Pageable pageable);
}
